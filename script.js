    ...
    data: {
        ...
        linkdrip: {
            ...
            profile: {
                ...
                description: {
                    text: "Web development. HTML5 CSS3 JS jQuery NodeJS W3. Graphic designer, UI UX, Tech entrepreneur & Traveler < /martech> 🏳️‍🌈 🧳 ♋ 🌮🏊‍♂️ 🧙‍"

                }
            },
            links: [{
                    url: "http://twitter.com/luisangelmaciel",
                    label: "twitter"
                },
                {
                    url: "https://codepen.io/luisangelmaciel",
                    label: "codepen"
                },
                {
                ...
                {
                    url: "https://dribbble.com/luisangelmaciel",
                    label: "dribbble"
                }
            ]
        }
